...
const Header: React.FC = () => {
  ...
  // Safely try to get auth state, with fallback values
  ...
  try {
    ...
    // Auth context not available, use default values
    console.log("Auth context not available in Header, using defaults");
  }
      ...
      <div className="w-full bg-white/10 backdrop-blur-md py-4 px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-white bg-slate-700 hover:bg-slate-600">
                  Sign In
                    ...
                    <li>
                      <NavigationMenuLink asChild>
                        <a 
                          ...
                          className={cn(navigationMenuTriggerStyle(), "cursor-pointer flex items-center justify-start gap-2")}
                        >
                          Teacher Login
                        </a>
                      </NavigationMenuLink>
              ...
              <NavigationMenuItem className="bg-slate-700">
                <NavigationMenuLink asChild>
                  <a 
                    ...
                    className={cn(navigationMenuTriggerStyle(), "cursor-pointer bg-transparent text-white hover:bg-white/20")}
                  >
                    Contact & Pricing
                  </a>
                </NavigationMenuLink>
