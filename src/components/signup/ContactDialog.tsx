...
const PricingPlan: React.FC<PricingPlanProps> = ({ title, credits, price, bestFor, isPopular }) => (
          ...
          <TabsContent value="pricing" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <PricingPlan
                ...
                credits={500}
                price="NT$99"
                bestFor="Small groups or test use"
              />
              <PricingPlan
                title="Standard"
                credits={1000}
                price="NT$159"
                bestFor="Regular classroom activity"
                isPopular={true}
              />
              <PricingPlan
                title="Pro"
                credits={1750}
                price="NT$199"
                bestFor="Large classes or full access"
              />
            </div>
            ...
            <div className="glass-card p-6 rounded-xl mt-6">
              ...
              <div className="grid gap-3 text-white/80 text-sm">
                <div>• 1 Credit = 1 Pokémon reward for students</div>
                <div>• Credits never expire once purchased</div>
                <div>• Use credits across all your classes</div>
                <div>• Track usage in your teacher dashboard</div>
