    ...
    <div className="flex flex-col items-center">
      <div className="mb-4 relative w-48 h-48 flex items-center justify-center">
        <img 
          ...
          className={`w-40 h-40 object-contain transition-transform ${isOpening ? 'animate-pulse scale-110' : 'hover:scale-105'}`} 
        />
        {isOpening && (
