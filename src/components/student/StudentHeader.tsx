...
const StudentHeader: React.FC<StudentHeaderProps> = ({
  ...
  return <Card className="mb-6 border-none shadow-lg bg-gradient-to-r from-red-400 to-red-500 text-white">
      <CardContent className="p-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between md:items-center gap-4">
          ...
          <div className="flex gap-2">
            ...
            {activeBattles.length > 0 && <Button className="bg-red-500 hover:bg-red-600 flex items-center gap-2" onClick={() => navigate("/student/battles")}>
                <Sword className="h-4 w-4" />
                {t("active-battles") || "Active Battles"} ({activeBattles.length})
              </Button>}
            
            <Button className="bg-blue-500 hover:bg-blue-600 flex items-center gap-2" onClick={() => navigate("/student/messages")}>
