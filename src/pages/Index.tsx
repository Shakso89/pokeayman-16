      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="glass-card rounded-3xl p-8 mb-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg max-w-3xl mx-auto mb-8 text-center text-slate-700 font-medium md:text-2xl">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-10 sparkle-animation text-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-gray-600">Collect & Battle</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">Surprise Pokémon rewards through our mystery ball system.</p>
                </div>
              </div>
            </div>
