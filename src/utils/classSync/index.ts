...
import { createClass as addClass, updateClassDetails as updateClass, getClassById as getClass, getClassesBySchool } from './classOperations';
...
export {
  addClass, updateClass, getClass, getClassesBySchool,
